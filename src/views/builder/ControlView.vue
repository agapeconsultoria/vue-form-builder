<template>
  <div :class="[control.containerClass, 'control-view-wrapper', control.additionalContainerClass]">
    <div
      class="control-view option-control drag-item"
      :class="{'active': isActive}"
      @click="openConfiguration"
    >
      <!-- render the label -->
      <ControlLabel v-show="control.isShowLabel" :control="control" @delete="deleteControl" />
...
<style>
.control-view-wrapper:hover .exclude {
  display: block;
}
</style>
