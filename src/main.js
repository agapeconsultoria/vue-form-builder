...
/* const messages = {
  ptBR: {
    canvas: {
      ...
      normal_block_name: 'Bloco Normal',
      normal_block_description: 'Bloco Normal com Título',
      toggleable_block_name: 'Bloco Alternável',
      toggleable_block_description: 'Bloco de seção com recurso alternar (exibir / ocultar)',
