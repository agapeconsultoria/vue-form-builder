<template>
  <div id="app">
    ...
    <p class="text-center">
      Presented by
      <strong>Seth (Sandaru) Phat</strong>
    </p>
    <h4 class="text-center mb-3">
      What you
      <strong>BUILD</strong> is what you
      <strong>GOT</strong>.
    </h4>
    ...
    <div class="col-md-12">
      ...
      <button
        ...
        @click="setData"
      >Set JSON Form-Data (Basic Configuration / Builder)</button>
      ...
      <button class="btn btn-info mr-2" @click="viewRenderer">
        ...
        <span v-show="!isRenderer">View Renderer Form from Basic Configuration</span>
      </button>
      <button
        class="btn btn-info mr-2"
        @click="isShowDevNote = !isShowDevNote"
      >Show Development Note</button>
    </div>
